...
if __name__ == "__main__":
    nienet_host = "192.168.1.21"
    l = EnetLib(nienet_host)
    ud = l.ibdev(pad=5,tmo=11)
	#print "ibwrt", l.ibwrt(ud, "TIME_DIV?\n")
    #print "ibrd", l.ibrd(ud, 1)
    print "ibrsp", l.ibrsp(ud)
    print "iblines", l.iblines(ud)
    #print "ibtrg", l.ibtrg(ud)
    print "ibask", l.ibask(ud, 1)
    #print "ibash", l.ibask(ud, 0xf)
    print "ibln 13", l.ibln(ud, 5)
    #print "ibln 11", l.ibln(ud, 11)
    print "ibwrt", l.ibwrt(ud, "*IDN?")
    print "ibrd", l.ibrd(ud, 512)
